...
public class MainPage {
    ...
    private  WebElement profileLinkInNavBar;
    ...
    public void clickUserNameLabel(){wait.until(ExpectedConditions.visibilityOf(UsernameLinkInNavBar)).click();}

    public void clickProfileLink(){ wait.until(ExpectedConditions.visibilityOf(profileLinkInNavBar)).click();}
